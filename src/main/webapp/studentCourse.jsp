...
<div class="mt-[8.5rem] mx-4 md:mx-20">

    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
       <%
        Map<String, List<Course>> courseList = (Map<String, List<Course>>) request.getAttribute("courseList");
           if (courseList != null && !courseList.isEmpty()) {
            for (Map.Entry<String, List<Course>> entry : courseList.entrySet()) {
            String  username = entry.getKey();
              List<Course>  courses = entry.getValue();

       %>

<div class="sm-w-md m-1.5 flex h-12 w-md items-center justify-start uppercase">
  <p class="px-20 py-24 text-xl font-semibold text-pretty">Welcome, <%= username %></p>
</div>
